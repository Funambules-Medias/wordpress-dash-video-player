...
function shaka_player_shortcode( $atts ) {
    ...
    wp_enqueue_style('shaka-player-custom', 'https://cdnjs.cloudflare.com/ajax/libs/shaka-player/4.2.2/controls.min.css');
    wp_enqueue_style('shaka-player-controls', plugin_dir_url(__FILE__).'css/custom.css');
